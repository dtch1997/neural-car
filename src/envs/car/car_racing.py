"""
OpenAI Gym environment for Dubin's car
Adapted from https://github.com/NotAnyMike/gym/blob/master/gym/envs/box2d/car_racing.py
"""
...
class CarRacing(gym.Env, EzPickle):
    ...
    def _get_track(self, num_checkpoints, track_rad=200/SCALE, x_bias=0, y_bias=0):
