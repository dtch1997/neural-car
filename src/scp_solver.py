...
if __name__ == "__main__":
    ...
    epsilon = 1e-2 #value to check for convergence of cost function
    ...
    for _ in range(1000):
      ...
      while diff > epsilon:
          optval = solver.solve()
          diff = abs(optval - prevOpt)
          prevOpt = optval

      #jerk,pinch = solver.input
      jerk = solver.variables.jerk.value
      pinch = solver.variables.pinch.value
